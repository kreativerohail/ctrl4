...
export default function Home() {
  ...
  return (
    ...
    >
      {/* ================= GRID BOX BACKGROUND (GUARANTEED) ================= */}
<div
...
/>
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-[80px_1fr] gap-14">
        ...
        >
          ...
          <span
            className="text-cyan-400 text-[10px] tracking-[0.4em]
        ...
        <div>
          ...
          >
            Where Leadership
            <br />
            <span className="text-cyan-400">Meets Clarity</span>
          </motion.h1>
          ...
          >
            CTRL4 advises senior leadership teams on navigating complexity
            across operations, security, and digital change — enabling
            confident decisions backed by structure, insight, and experience.
          </motion.p>
          ...
          {/* TRUST STRIP */}
          <div
            className="mt-20 mb-10 grid grid-cols-2 sm:grid-cols-4 gap-10
